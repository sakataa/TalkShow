...
using ASP5AttributeRouting.Models;

namespace ASP5AttributeRouting.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("ASP5AttributeRouting.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("ASP5AttributeRouting.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
